...
themes_dir                          = os.getenv("HOME") .. "/.config/awesome/themes/stock"
theme.wallpaper1                     = themes_dir .. "/wall1.png"
theme.wallpaper2                     = themes_dir .. "/wall2.png"
theme.wallpaper3                     = themes_dir .. "/wall3.png"
